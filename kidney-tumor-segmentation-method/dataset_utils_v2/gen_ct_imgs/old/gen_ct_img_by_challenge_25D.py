...
def generate_imgs_masks_2d(path_root, output_dir, width, height, only_injuries_slices=False, only_lesion_mask=False, histogram_specification=False, dilation_f=False):
    ...
    kidney_predictions_path = r"E:\DoutoradoLuana\datasets\nii\KW_V5_1_reconstruido_com_pred_RW_V5_2"
    for folder in folders:
        ...
        #     folder+"prediction.nii.gz", sitk.sitkUInt8)
        gt_name = "prediction_"+nome_paciente.replace("case_", "")+".nii.gz"
        gt_prediction = sitk.ReadImage(
            os.path.join(kidney_predictions_path, gt_name))
...
if __name__ == '__main__':
    ...
    # Lua
    dataset_root_dir = r"D:\DOUTORADO_LUANA\etapa1\bases2D\teste challenge\teste challenge"

    output_dir = r'E:\DoutoradoLuana\datasets\gerados\challenge\pred_KW_V5_1_reconstruido_com_pred_RW_V5_2'
