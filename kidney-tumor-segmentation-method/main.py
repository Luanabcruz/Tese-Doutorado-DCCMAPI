...
from kidney_dataset_utils.misc.split_kits19 import load_dataset_dist
...
# from networks.lua_res_unet_att import LuaResUnetAtt
...
def run_nn():
    ...
    """
    # root_dir =  r'D:\DoutoradoLuana\datasets\gerados\Kits19_25D_with_kidney_masks\Kits19_npz_25D_512_todas_fatias_rim'
    root_dir =  r'D:\DoutoradoLuana\datasets\gerados\Kits19_25D_with_tumor_masks\KiTS19_master_npz'
    
    #reconstrucao
    # root_dir =  r'D:\DoutoradoLuana\datasets\gerados\Kits19_npz_25D_rebuild_tumor_512_sem_EH'
    ...
    log_path = get_log_path(data_aug, cnn, loss_name,
                            backbone, dpa_dist, in_channels,sufix = '')
    print("###\n")
    ...
    model = torch.load(r'C:\Users\domin\Desktop\kf4\weights_final.pt', map_location={'cuda:1': 'cuda:0'})
    # model = LuaResUnet(in_ch=3, out_ch=1).cuda()
    # model = ResUNet(in_ch=3, out_ch=1).cuda()
    # model = LuaResUnetAtt(in_ch=3, out_ch=1).cuda()
    model.train()
