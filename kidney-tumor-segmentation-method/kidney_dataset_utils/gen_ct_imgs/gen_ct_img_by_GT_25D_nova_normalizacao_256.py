...
def generate_imgs_masks_2d(path_root, output_dir, local, width, height, only_injuries_slices=False, histogram_specification=False):
    ...
    for folder in folders:
        ...
        imagem_especificada_array = lua_normalize(imagem_array)
...
if __name__ == '__main__':
    ...
    output_dir = r'E:\DoutoradoLuana\datasets\gerados\Kits19_25D_with_tumor_masks_new_norm_and_windowing'
