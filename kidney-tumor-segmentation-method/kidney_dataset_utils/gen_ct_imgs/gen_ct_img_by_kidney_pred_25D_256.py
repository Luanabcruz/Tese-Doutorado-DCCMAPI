...
def generate_imgs_masks_2d(path_root, output_dir, width, height, only_injuries_slices=False, only_lesion_mask=False, histogram_specification=False, dilation_f=False):
    ...
    for folder in folders:
        ...
        imagem_original_bb_array, gt_original_bb_array, imagem_prediction_bb_array, gt_prediction_bb_array = delimite_predict_origin(
...
if __name__ == '__main__':
    ...
    output_dir = r'E:\DoutoradoLuana\datasets\gerados\kits19_saida_etapa_1\resunet101_25D_balanced_256'
