...
if __name__ == '__main__':
    root_file = os.path.dirname(os.path.dirname(
        os.path.dirname(os.path.abspath(__file__))))

    sys.path.append(root_file)

    import otimizacao_preprocessing.preprocessings as pp
...
def generate_imgs_masks_2d(path_root, output_dir, local, width, height, only_injuries_slices=False, histogram_specification=False):
    ...
    # nenhum,bilateral,unsharp_mask => pre processamentos
    preprocessing_params = [0, 1, 3, 0.2699019772628977,
                            0.39912823801498637, 3.336951079452735, 33, 5, 1]
    for folder in folders:
        ...
        imagem_especificada_array = pp.apply_preprocessing_list(
            imagem_especificada_array, preprocessing_params)
...
if __name__ == '__main__':
    ...
    output_dir = r'E:\DoutoradoLuana\datasets\gerados\trash_pre_processamento'
