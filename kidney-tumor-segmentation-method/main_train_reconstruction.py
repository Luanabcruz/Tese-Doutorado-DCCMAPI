...
def run_nn():
    ...
    dataset_spreed_id = "dpa_runs_reconst_hf3"
    ...
    model = torch.load(r'D:\DoutoradoLuana\PESOS_TESE_KFOLD\HF5\reconstruction\reconstruction_HF5.pt', map_location={'cuda:1': 'cuda:0'}  )
    model.train()
