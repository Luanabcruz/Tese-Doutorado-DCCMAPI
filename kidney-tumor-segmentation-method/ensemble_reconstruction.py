...
for fold in folds:
    weights.append('../../PESOS_TESE/F{}/reconstruction/reconstruction_resunet101_f{}.pt'.format(fold,fold))
...
outdir = '../../RESULTADOS_TESE/ensemble/reconstruction'

nii_saver =  CTSaver(outdir=outdir, outlabel= 3)
...
for case in cases:
    ...
    worksheet_name = "reconst_ensembled"
    try:
